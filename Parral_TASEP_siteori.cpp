...
//site oriented approach and for Parallel Update
...
#define FILE_NAME "results_siteori2.dat"	//Name of file where results are stored
...
void move(int rho, int run_time){
	...
	int q = 0; 					//To see how many cars have been seen
	//cout<<"From here: "<<endl;
	...
	for(int i = 0; i<N; i++){
		...
		int t = q;		//Which car will be moves (In sequential order)
		q++; 			//To update q
